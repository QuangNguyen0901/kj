...
define( 'SVW_API_GHN_URL', 'https://console.ghn.vn' ); //product=>'https://console.ghn.vn'  test=>http://api.serverapi.host);
define( 'SVW_API_GHTK_URL', 'https://services.giaohangtietkiem.vn' ); //product => https://services.giaohangtietkiem.vn  test=>https://dev.ghtk.vn
